...
function Deck({ data, updateMean, result, refreshMeanDraw, langage, changeLangage }) {
    ...
    function showModalInfo() {
        const modalInfo = document.querySelector(".modalInfoHide");
        const classesInfo = modalInfo.classList;
        classesInfo.toggle("showInfo");
    };
    ...
    return (
        <div className="deck">
            ...
            <div className="divMean">
                ...
                {/* Modale Info */}
                <div className="divInfoButton"><img className="infoButton" src={process.env.PUBLIC_URL + "/information-button-white.png"} onClick={showModalInfo} alt="Information" /></div>
                <div className="modalInfoHide">
                    <div className="tuto">
                        {langage ?
                            (<><div className="img"><img src={process.env.PUBLIC_URL + "/drag'n drop.png"} alt="icon drag'n drop" /><span>Maintenez votre doigt appuyé sur l'arcane de votre choix tout en le déplaçant</span></div>
                                <hr />
                                <div className="img"><img src={process.env.PUBLIC_URL + "/click.png"} alt="icon clic" /><span>Clicker dessus pour le retourner</span></div></>) :
                            (<><div className="img"><img src={process.env.PUBLIC_URL + "/drag'n drop.png"} alt="icon drag'n drop" /><span>Keep your finger pressed on the arcana of your choice while moving it</span></div>
                                <hr />
                                <div className="img"><img src={process.env.PUBLIC_URL + "/click.png"} alt="icon clic" /><span>Click on it to return it</span></div></>)
                        }
                    </div>
                    {langage ?
