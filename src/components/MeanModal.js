...
export default function MeanModal(result, langage) {
    ...
    const allArcanes = {
        ...
        "arc16": {
            ...
            "atout": "La Maison Dieu en atout est le signe d'une révélation et/ou d'une libération. Cette arcane vous indique que l'épreuve que vous traversez est nécessaire. Vous en sortirez grandi.",
        ...
        "arc22": {
            ...
            "opp": "Le Mat en opposition évoque la folie, l'imprudence et le manque de préparation dans une situation ou un projet.",
