...
function Column({ column, cards, updateDiscovery, langage }) {
                ...
                {provided => (
                    <div {...provided.droppableProps}
                        ...
                        {cards.map((card, index) => (
                            <Card key={card.id} card={card} index={index} updateDiscovery={updateDiscovery} langage={langage} />
                        ))}
                    </div>
